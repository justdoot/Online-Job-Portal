...
const ViewEmployerJobApplication = () => {
  ...
  const retrieveAllStatus = async () => {
    const response = await axios.get(
      "http://localhost:8081/api/helper/job/application/status/fetch/all"
    );
  ...
  const updateJobApplicationStatus = (e) => {
    ...
    if (assignApplicationId === "" || applicationStatus === "") {
      ...
      fetch("http://localhost:8081/api/job/application/update/status", {
        method: "PUT",
        headers: {
  ...
  const retrieveAllJobApplication = async () => {
    const response = await axios.get(
      "http://localhost:8081/api/job/application/fetch/all/employer?employerId=" +
        employer.id,
      {
        headers: {
