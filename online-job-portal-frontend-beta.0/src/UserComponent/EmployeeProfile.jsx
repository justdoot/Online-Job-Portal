...
const EmployeeProfile = () => {
  ...
  const addEmployeeSkill = (e) => {
    fetch("http://localhost:8081/api/user/profile/skill/update", {
      method: "PUT",
      headers: {
  ...
  const addEmployeeQualification = (e) => {
    fetch("http://localhost:8081/api/user/profile/education/update", {
      method: "PUT",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
  ...
  const addEmployeeWorkExperience = (e) => {
    fetch("http://localhost:8081/api/user/profile/work-experience/update", {
      method: "PUT",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
  ...
  const retrieveAllUser = async () => {
    const response = await axios.get(
      "http://localhost:8081/api/user/fetch?userId=" + fetchedEmployee.id
      // ,
      // {
      //   headers: {
  ...
  const downloadResume = async () => {
    try {
      const response = await axios.get(
        `http://localhost:8081/api/user/employee/resume/${fetchedEmployee.userProfile.resume}/download?employeeId=${fetchedEmployee.id}`,
        {
