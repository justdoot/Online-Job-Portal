...
const HomePage = () => {
  ...
  const retrieveAllCategories = async () => {
    const response = await axios.get(
      "http://localhost:8081/api/job/category/fetch/all"
    );
    return response.data;
  };
  const retrieveAllJobTypes = async () => {
    const response = await axios.get(
      "http://localhost:8081/api/helper/job/type/fetch/all"
    );
    return response.data;
  };
  const retrieveAllSalary = async () => {
    const response = await axios.get(
      "http://localhost:8081/api/helper/job/salary/range/fetch/all"
    );
    return response.data;
  };
  ...
  const retrieveAllJobs = async () => {
    const response = await axios.get("http://localhost:8081/api/job/fetch/all");
  ...
  const searchJobsByData = async () => {
    const response = await axios.get(
      "http://localhost:8081/api/job/search?categoryId=" +
        searchData.categoryId +
        "&jobType=" +
        searchData.jobType +
        "&salaryRange=" +
