...
const ViewEmployerJobs = () => {
  ...
  const retrieveAllJobs = async () => {
    const response = await axios.get(
      "http://localhost:8081/api/job/fetch/employer-wise?employerId=" +
        employer.id,
      {
        headers: {
  ...
  const deleteJob = (jobId, e) => {
    fetch("http://localhost:8081/api/job/delete?jobId=" + jobId, {
      method: "DELETE",
      headers: {
                  ...
                  return (
                    <tr>
                      ...
                      <td>
                        <img
                          src={
                            "http://localhost:8081/api/job/" + job.companyLogo
                          }
                          class="img-fluid"
                          alt="company_logo"
                          style={{
